...
namespace Piwik\Plugins\DeviceIntelligence\Commands;
...
final class TestRetentionCommand extends ConsoleCommand
{
    ...
    {
        $this->setName('deviceintelligence:test-retention');
        $this->setDescription('Test DeviceIntelligence data retention with dry-run mode.');
        $this->addOption(
            'execute',
            null,
