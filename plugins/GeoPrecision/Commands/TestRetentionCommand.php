...
namespace Piwik\Plugins\GeoPrecision\Commands;
...
final class TestRetentionCommand extends ConsoleCommand
{
    ...
    {
        $this->setName('geoprecision:test-retention');
        $this->setDescription('Test GeoPrecision data retention with dry-run mode.');
        $this->addOption(
            'execute',
            null,
